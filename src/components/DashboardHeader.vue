<template>
  ...
  <!--	  fonts-->
    ...
    <link v-if="getpath != '/'"  rel="stylesheet prefetch" href="/src/assets/css/all.min.css" defer>
    <link v-if="getpath != '/'" rel="stylesheet prefetch" href="/src/assets/css/bootstrap.min.css" defer>

    

      <link v-if="getpath != '/'" href="/src/assets/theme/media-query.css" rel="stylesheet" defer>
      <link v-if="getpath != '/'" href="/src/assets/theme/navbar.css" rel="stylesheet" defer>
      <!-- <link href="/src/assets/theme/icon.css" rel="stylesheet" defer> -->
    
    
    <!--	  style-->
      <link v-if="getpath != '/'" href="/src/assets/css/style.css" rel="stylesheet" defer>
      <link v-if="getpath != '/'" href="/src/assets/css/responsive.css" rel="stylesheet" defer>


        <nav class="navbar navbar-expand-lg " id="">
            <div v-if="getpath != '/'" class="container custom_container">
                ...
                <router-link v-if="getsettingpagereq == 1 &&  getusertype != 1 && getusertype != 2" to="/" class="navbar-brand" ><h1> {{getsettingpagedata[1].setting_value}} </h1></router-link>
...
export default {
    ...
    created(){
        ...
        // }
        this.$store.dispatch('changetitle',{title:'DashHeader'});
        this.$store.dispatch('setsettingdata');
        if(this.getpath != '/'){
