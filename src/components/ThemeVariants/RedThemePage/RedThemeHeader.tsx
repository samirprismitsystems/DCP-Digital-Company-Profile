export default function RedThemeHeader() {
  return (
    <section
      ...
      <div className="container h-full inline-flex justify-center items-center pb-12">
        <div className="row profile_row flex flex-wrap -mr-3 -ml-3">
          ...
          <div className="text-center w-full">
            <div
              className="profile_image w-60 h-60 rounded-50 bg-white flex items-center justify-center  overflow-hidden m-auto xs:top-[67%] md:top-[74%] left-0 right-0 absolute translate-y-(-20%) border-[0.8rem] border-white border-solid "
              style={{
