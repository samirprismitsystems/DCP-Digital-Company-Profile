...
import { faClock, faSave, faShareAltSquare } from "@fortawesome/free-solid-svg-icons";
            ...
            >
                <div className="container">
                    <div className="grid grid-cols-1 gap-x-8 gap-y-14 diamondSm:grid-cols-2 diamondLg:grid-cols-4 px-0 py-8 diamondMd:p-0">
                        <SingleFeature link={`https://wa.me/+91${objCompany.company_contact}`} icon={faSquareWhatsapp} title="WhatsApp" desc={`+91 ${objCompany.company_contact}`} />
