...
const SingleBrand = (props: {
    ...
    return (
        <div className="mx-3 py-4 px-0 flex w-full items-center justify-center bg-[#F9FAFB] shadow-md h-full min-h-[200px] relative hover:shadow-lg dark:bg-diamond-black">
