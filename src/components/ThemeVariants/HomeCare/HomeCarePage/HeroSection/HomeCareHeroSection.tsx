    ...
    <>
      ...
      >
        <div className="w-full text-center max-w-full">
          <div className="brand-image w-72 table  ml-auto mr-auto mt-auto mb-7 text-center">
            <div className="brand-img w-auto m-auto table-cell h-32 align-middle text-center">
              <Image
          ...
          <h5 className="link_title font-medium">Founder &amp; CEO</h5>
        </div>
      </div>
    </>
  );
