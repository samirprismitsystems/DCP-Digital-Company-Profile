...
export default function Hero() {
    ...
    return (
        <>
            <div id="home" className='bg-silver-lightkblue'>
                <div className="container min-w-7xl w-full py-72 md:py-[25rem] sm:pb-24 px-6">
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                        <div className='flex flex-col justify-evenly'>
                            ...
                            <div className='flex mt-8 items-center justify-center md:justify-start  pt-10 lg:pt-4'>
                                <button className="bg-silver-common text-white text-2xl rounded-md px-12 py-6" onClick={() => {
