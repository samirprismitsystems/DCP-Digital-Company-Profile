    ...
    <>
      ...
      >
        <div className="h-full  flex flex-wrap xl:flex-nowrap xs:flex-col lg:flex-row -mt-4 -mb-4">
          <div className="relative z-0 h-screen xs:h-[30vh] xl:h-screen xs:w-full w-2/4">
            <picture className="block h-full xs:h-auto">
              <img
                className="md:h-[42vh] h-full w-full xl:h-screen object-center object-cover"
          ...
          <div className="relative  z-0 xs:h-[63vh] lg:h-screen h-screen sm-h-screen w-2/4 xs:w-full bg-white">
            <div className="w-full xs:flex lg:block h-full p-20  md:p-20 xl:flex">
              <div className="w-full h-full xs:h-auto  md:p-20 flex justify-center items-center flex-row">
                <div className="w-3/4 xs:w-full m-auto  text-center">
                  <h1 className="xl:text-5xl font-normal text-black xs:text-[2.5rem]">
                    Forgot Password?
                  </h1>
                  <h2 className="py-12 text-[1.8rem] text-black">
