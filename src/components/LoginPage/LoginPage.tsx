    ...
    <>
      ...
      >
        <div className="h-full flex flex-wrap xl:flex-nowrap xs:flex-col lg:flex-row -mt-4 -mb-4">
          ...
          <div className="relative z-0 h-screen sm:h-auto w-2/4 xs:w-full bg-white">
            <div className="w-full h-full p-20 xs:p-16 md:p-20">
              <div className="xl:pt-48 xs:pt-0 w-3/4 xs:w-full m-auto md:w-3/4">
                <h1 className="xs:text-5xl text-black text-center xl:text-7xl font-bold">
                  Welcome to
                </h1>
                <h2 className="xs:text-5xl pt-8 pb-8 text-center text-secondary-main xl:font-bold xl:text-7xl">
