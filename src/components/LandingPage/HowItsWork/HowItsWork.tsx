          ...
          <div className="container mx-auto flex md:px-0 px-5 xs:py-0 py-16 md:flex-row flex-col md:items-start lg:items-center">
            ...
            <div className="sm:items-start md:item-center md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center xs:items-start">
              <MainScrollAnimation>
                ...
                <div
                  className={`${styles.howItsWorks} text-white xs:text-left md:text-left  text-[1.8rem] pb-4`}
        ...
        <div className="container mt-20 mx-auto flex md:px-0 px-5  md:flex-row flex-col md:items-start lg:items-center">
          ...
          <div className="xs:items-start md:w-1/2 flex flex-col text-left ">
            <MainScrollAnimation>
              ...
              <div
                className={`${styles.howItsWorks} text-white xs:text-left lg:pr-24 md:pr-16 text-[1.8rem] pb-4`}
