...
export default function FreeTrail() {
  ...
  return (
    <div className="container md:my-48 mx-auto flex md:flex-row flex-col items-center md:justify-between lg:justify-around">
      <div className="container  xs:w-full sm:w-[55%] align-middle mb-10 md:mb-0 lg:w-[30%] ">
        <img
          className="max-w-full h-auto w-full block m-auto"
          alt="hero"
          src="/assets/landing/mobile_overlay_sm.webp"
        />
      </div>
      <div className="container sm:w-full md:w-1/2 flex flex-col xs:items-start md:items-start  md:text-left lg:items-left text-left lg:w-1/2">
